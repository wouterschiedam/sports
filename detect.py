...
TARGET_VIDEO_PATH = [
     "./content/processed/08fd33_0.mp4",
     "./content/processed/0bfacc_0.mp4",
     "./content/processed/121364_0.mp4",
     "./content/processed/2e57b9_0.mp4",
     "./content/processed/573e61_0.mp4"
];
...
for SOURCE_VIDEO, TARGET_VIDEO in zip(SOURCE_VIDEOS, TARGET_VIDEO_PATH):

    video_info = sv.VideoInfo.from_video_path(SOURCE_VIDEO);
    video_sink = sv.VideoSink(TARGET_VIDEO, video_info=video_info);
